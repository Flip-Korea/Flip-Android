...
fun FlipDropdownButton(
    ...
    OutlinedButton(
        ...
        border =
            BorderStroke(1.dp, if (isSelect) FlipTheme.colors.point else FlipTheme.colors.gray4),
        ...
        Row(
            ...
            Icon(
                modifier = Modifier.graphicsLayer { rotationZ = rotationAnimated },
...
private fun FlipDropdownButtonPreview() {
    ...
    FlipDropdownButton(isSelect = isSelect, text = "Option", onClick = { isSelect = !isSelect })
}
