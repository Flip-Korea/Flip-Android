    ...
    constructor(
            ...
            flow {
                ...
                when (
                    ...
                    is Result.Success -> {
                        val profileId =
                            dataStoreManager
                                .getStringData(DataStoreType.AccountType.CURRENT_PROFILE_ID)
                                .first()
        ...
        override fun editMyProfile(
            ...
            flow {
                ...
                when (
                    val result =
                        userNetworkDataSource.editMyProfile(profileId, editProfile.toNetwork())
                ) {
                    is Result.Success -> {
                        val profileEntity = myProfileDao.getProfileById(profileId).firstOrNull()
                        profileEntity?.let {
                            val updateProfileEntity =
                                it.copy(
        ...
        override fun getFollowerListPagination(
            ...
            flow {
                ...
                when (
                    val result = userNetworkDataSource.getFollowerList(profileId, cursor, limit)
                ) {
                    is Result.Success -> {
        ...
        override fun getFollowingListPagination(
            ...
            flow {
                ...
                when (
                    val result = userNetworkDataSource.getFollowingList(profileId, cursor, limit)
                ) {
                    is Result.Success -> {
        ...
        override fun getMyCommentListPagination(
            ...
            flow {
                ...
                when (
                    val result = userNetworkDataSource.getMyCommentList(profileId, cursor, limit)
                ) {
                    is Result.Success -> {
