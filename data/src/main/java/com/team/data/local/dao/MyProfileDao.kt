...
interface MyProfileDao {
    ...
    @Upsert suspend fun upsertProfile(profileEntity: MyProfileEntity)

    @Upsert suspend fun upsertAll(profileEntities: List<MyProfileEntity>)

    @Delete suspend fun deleteProfile(profileEntity: MyProfileEntity)

    @Query("DELETE FROM myprofileentity") suspend fun deleteAll()
