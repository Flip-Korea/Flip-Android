...
constructor(
    ...
    fun login(socialLoginPlatform: SocialLoginPlatform, authManager: AuthManager) {
        authManager
            .signIn()
            .onEach { authUiState ->
                when (authUiState) {
    ...
    private fun signIn(socialLoginPlatform: SocialLoginPlatform, accountId: String) {
        loginUseCase(socialLoginPlatform, accountId)
            .onEach { result ->
                when (result) {
                    Result.Loading -> {}
                    is Result.Error -> {
