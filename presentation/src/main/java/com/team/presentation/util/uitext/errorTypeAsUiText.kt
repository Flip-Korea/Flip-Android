...
fun ErrorType.asUiText(): UiText =
    when (this) {
        /** Exception */
        ErrorType.Exception.IO ->
            UiText.StringResource(
                R.string.error_exception_io,
            )

        ErrorType.Exception.TIMEOUT ->
            UiText.StringResource(
                R.string.error_exception_timeout,
            )

        ErrorType.Exception.JSON_DATA ->
            UiText.StringResource(
        ...
        ErrorType.Local.UNEXPECTED ->
            UiText.StringResource(
                R.string.error_local_unexpected,
            )

        /** Token */
        ErrorType.Token.NOT_FOUND ->
            UiText.StringResource(
        ...
        ErrorType.Auth.TOKEN_ERROR ->
            UiText.StringResource(
                R.string.error_auth_token_error,
            )

        ErrorType.Auth.CANCELLED ->
            UiText.StringResource(
