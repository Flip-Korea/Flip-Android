...
fun NavGraphBuilder.addFlipNavigation(
    ...
    navigation(
        ...
        composable(
            ...
            enterTransition = {
                FlipTransitionObject.enterTransition(FlipTransitionDirection.Bottom)
            },
            exitTransition = { exitTransition(currentRoute) },
            popEnterTransition = { popEnterTransition(currentRoute) },
            popExitTransition = {
                FlipTransitionObject.exitTransition(FlipTransitionDirection.Bottom)
            },
        ) {
            AddFlipRoute(
        ...
        composable(
            ...
            enterTransition = {
                FlipTransitionObject.enterTransition(FlipTransitionDirection.Right)
            },
            exitTransition = { FlipTransitionObject.exitTransition(FlipTransitionDirection.Right) },
            popExitTransition = {
                FlipTransitionObject.exitTransition(FlipTransitionDirection.Right)
            },
        ) {
            TempFlipBoxRoute(onBackPress = popBackStack)
        }
    }
}
...
private val exitTransition: (String) -> ExitTransition = {
    when (it) {
        ScreenItem.TEMP_FLIP_BOX.name ->
            FlipTransitionObject.exitTransition(FlipTransitionDirection.Left)
