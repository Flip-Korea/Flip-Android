...
val bottomNavItems =
    listOf(BottomNavItem.Home, BottomNavItem.Flip, BottomNavItem.AddFlip, BottomNavItem.Profile)

val allowedBottomNavItems = listOf(BottomNavItem.Home, BottomNavItem.Flip, BottomNavItem.Profile)
